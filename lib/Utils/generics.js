...
exports.isWABusinessPlatform = exports.getCodeFromWSError = exports.getCallStatusFromNode = exports.getErrorCodeFromStreamError = exports.getStatusFromReceiptType = exports.generateMdTagPrefix = exports.fetchLatestWaWebVersion = exports.fetchLatestzansxartVersion = exports.fetchLatestBaileysVersion = exports.printQRIfNecessaryListener = exports.bindWaitForConnectionUpdate = exports.generateMessageID = exports.generateMessageIDV2 = exports.delayCancellable = exports.delay = exports.debouncedTimeout = exports.unixTimestampSeconds = exports.toNumber = exports.encodeBigEndian = exports.generateRegistrationId = exports.encodeNewsletterMessage = exports.encodeWAMessage = exports.unpadRandomMax16 = exports.writeRandomPadMax16 = exports.getKeyAuthor = exports.BufferJSON = exports.getPlatformId = exports.Browsers = void 0;
...
const zansxart_version_json_1 = require("../Defaults/zansxart-version.json");
...
const fetchLatestzansxartVersion = async (options = {}) => {
    try {
        const { data } = await axios_1.default.get('https://registry.npmjs.org/zansxart', {
            ...options,
            responseType: 'json'
        });
        ...
        return {
            version: zansxart_version_json_1.version,  
            isLatest: false,
            error
        };
    }
};
exports.fetchLatestzansxartVersion = fetchLatestzansxartVersion;

const fetchLatestBaileysVersion = async (options = {}) => {
    try {
        const { data } = await axios_1.default.get('https://raw.githubusercontent.com/WhiskeySockets/Baileys/master/src/Defaults/index.ts', {
            ...options,
            responseType: 'text'
        });

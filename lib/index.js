...
// Handle chalk-animation if it's imported as an object (ESM/CJS compat)
if (chalkAnimation.default) {
    chalkAnimation = chalkAnimation.default;
}
...
let anim;
try {
    if (typeof chalkAnimation.rainbow === 'function') {

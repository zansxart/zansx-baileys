...
const systemInfo = () => {
    ...
    // FIX: Use chalk.bold(gradient(...)) instead of gradient.bold(...)
    console.log("   " + chalk.bold(accent("» SYSTEM CORE LOADED «")));
    console.log(chalk.gray("   ──────────────────────────────────────────"));
    
    const info = [
        { key: "LIBRARY ", val: "zansx-baileys", color: chalk.cyan },
        { key: "VERSION ", val: "v0.5.5 (Stable)", color: chalk.green },
    ...
    console.log(chalk.gray("   ──────────────────────────────────────────"));
    console.log("   " + chalk.bold(primary("READY TO PROCESS INCOMING REQUESTS...")));
    console.log();
};

// Start Animation
let anim = null;
const logoGradient = gradient(['#00c6ff', '#0072ff']);

if (chalkAnimation && typeof chalkAnimation.glitch === 'function') {
    try {
        anim = chalkAnimation.glitch(logoGradient(logo));
    } catch (e) {
